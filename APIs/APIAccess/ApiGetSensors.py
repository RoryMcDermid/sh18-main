...
systemIdToFind = input("What system would you like the sensors for?\n")
...
with open("../../web-app/src/data/Sensors/" + systemIdToFind + "SensorList" +".json", "w") as outfile:
    json.dump(listOfSensors, outfile, indent = 2)